...
//     "http://localhost:3000" , 
//     // "http://192.168.1.2:3000/auth/google?platform=mobile",
...
// //     if (provider === "gmail") {
// //       const authUrl = `${BACKEND_URL}/auth/google?platform=mobile`; // mobile login
// //       const redirectUrl = Linking.createURL("/InboxScreen"); // deep link
